                    ...
                    <div className="relative min-h-screen flex flex-1 bg-gray-950">
                        ...
                        <main className="relative top-0 flex flex-col items-center justify-center  w-full h-screen">
                            ...
                            <div className="sticky bottom-0 max-w-3/5 max-lg:max-w-full lg:w-3/5 min-w-0 max-h-2/3 flex flex-row items-center h-24 gap-4">
                                ...
                                <div className="grow flex max-h-max items-center justify-center rounded-full bg-gray-900"> <textarea name="prompt" placeholder="say anything.." defaultValue={""}  className="text-2xl max-lg:text-lg  text-white resize-none w-full px-7 content-center outline-0"></textarea></div>
                                <button type="submit" className="text-white p-5 min-w-0 min-h-0 rounded-xl bg-gray-900/70"> <FaPaperPlane /> </button>
                            </div>
                        </main>
                    </div>
                    </form>
